...
export const LETTER_LESSONS = [
  {
    ...
    nikud: {
      ...
      HIRIK:  { display: 'בִּ', phonetic: 'בִּ',  example: 'בִּקְבּוּק 🍼' },
  ...
  },
  {
    ...
    nikud: {
      ...
      HIRIK:  { display: 'לִ', phonetic: 'לִ',  example: 'לִיצָן 🤡' },
  ...
  },
  {
    ...
    nikud: {
      KAMATZ: { display: 'כָּ', phonetic: 'כָּ',  example: 'כָּרִית 🛋️' },
  ...
  },
  {
    ...
    nikud: {
      ...
      KUBUTZ: { display: 'נֻ', phonetic: 'נֻ',  example: 'נֻגֶּט 🍗' },
    },
  },
  {

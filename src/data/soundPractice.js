...
export const SOUND_TARGETS = [
  {
    ...
    sentences: [
      { text: 'אֲנִי רוֹאָה סוּס',              emoji: '🐴' },
      { text: 'סָבָא סוֹחֵב סַל סָגֹל',         emoji: '🧺' },
      { text: 'הַסּוּס שֶׁל סַבְתָּא רָץ מַהֵר', emoji: '🐴' },
      { text: 'יֵשׁ לִי סִירָה קְטַנָּה',        emoji: '⛵' },
      { text: 'אֲנִי אוֹהֶבֶת סֻכָּרִיָּה',      emoji: '🍬' },
      { text: 'הַסֵּפֶר שֶׁלִּי עַל הַסֵּל',     emoji: '📖' },
    ],
  },
  {
    id: 'shin',
    ...
    sentences: [
      { text: 'אֲנִי רוֹאָה שֶׁמֶשׁ',            emoji: '☀️' },
      { text: 'שׁוֹשַׁנָּה שׁוֹתָה שׁוֹקוֹ',      emoji: '🍫' },
      { text: 'הַשָּׁפָן שֶׁלִּי אוֹהֵב שֶׁלֶג',  emoji: '🐰' },
      { text: 'יֵשׁ לִי שֵׁן חֲדָשָׁה',           emoji: '🦷' },
      { text: 'אֲנִי שׁוֹמַעַת שִׁיר יָפֶה',       emoji: '🎵' },
      { text: 'הַשָּׁעוֹן עַל הַשֻּׁלְחָן',        emoji: '⌚' },
    ],
  },
  {
    id: 'tsadi',
    ...
    hiss: 'צְצְצְ',
    sampleSyllable: 'צָה',
    cue: 'אוֹמְרִים T וּמִיָּד מַחְלִיקִים לְ-S, מַהֵר מְאוֹד: טְס! כְּמוֹ צִפּוֹר שֶׁפּוֹרַחַת בִּמְהִירוּת — צְ! 🐦',
    ...
    sentences: [
      { text: 'אֲנִי רוֹאָה צִפּוֹר',                 emoji: '🐦' },
      { text: 'הַצָּב צוֹעֵד לְאַט',                   emoji: '🐢' },
      { text: 'צִפּוֹר צְהֻבָּה צוֹבַעַת צִיּוּר',     emoji: '🎨' },
      { text: 'יֵשׁ לִי צֶמֶר כָּתֹם',                 emoji: '🧶' },
      { text: 'אֲנִי מְצַיֶּרֶת צִפּוֹר יָפָה',        emoji: '🐦' },
      { text: 'הַצָּב אוֹהֵב לָצֵאת לַשֶּׁמֶשׁ',       emoji: '🐢' },
    ],
  },
];
